...
<div class="col-md-4">
	<div class="panel panel-default">
		<div class="panel-heading"><strong>EDIT BRANCH</strong></div>
		<div class="panel-body">

        {{Form::model($branchesById, array('url'=>route('branches.update',$branchesById->id),'method'=>'put','class'=>'form-horizontal'))}}

            <div class="form-group">
            	<div class="col-sm-4">{{ Form::label('Branch Name') }}</div>
                <div class="col-sm-8">
                    {{ Form::text('branch_name',null,array('class'=>'form-control input-sm','required')) }}
                </div>
            </div>
            <div class="form-group">
